    ...
    return (
        <main className="section is-flex is-align-item-center is-justify-content-center">
            <div className="box" style={{maxWidth: "50vw"}}>
                <h1 className="title is-2 has-text-centered">About Diet Delight</h1>
                ...
                <div className="is-flex has-text-centered mt-5 mb-5">
                    ...
                    <div>
                        ...
                        <Link to="/#featuredrecipes" className="button is-warning mt-5">
                        Featured Recipes
                        </Link>
                    </div>
                </div>
                <div className="mb-5">
                    <p className="has-text-centered">With these tools, Fit Life Gym is committed to supporting your health and fitness, both inside and outside the gym.
                    </p>
                </div>
